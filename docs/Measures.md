Fish&Feats offers several options to quantify tissue properties at the single cell level:

* [Classify cells](./Classify-cells.md):<span style="background-color:#bda30f"> classify cells into user-defined categories</span>
